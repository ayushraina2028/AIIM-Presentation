...
\headerbox{Our Mentors}{name=mentors,column=2,below=subtopic2gap,span=1}{
    \begin{enumerate}
        \item {\Large Professor Debnath Pal (CDS Dept)}
...
\headerbox{Summary}{name=conclusion,column=0,below=topicoverview,span=2,above=bottom}{
\begin{enumerate}
...
\headerbox{6. Human Practices}{name=hp,column=2,below=mentors,span=1}{
\subsubsection*{3R's}
\begin{enumerate}
...
\headerbox{Links and Resources}{name=last,column=2,below=hp,span=1} {
    {
        \hspace{2.6cm}
        \centering
    	\includegraphics[scale=.014]{images/qr.png}
    }
}
